...
There are lots of client settings available, and this doc will guide you through them. If you are looking for client commands, read the URL TO Client Commands doc. To find out how to find the config file, read the URL TO Client Config doc.
...
|`cl_auto_demo_max` | 	Maximum number of automatically reccorded demos| 	10| 
...
|`cl_languagefile`| 	The languagefile to use	| | 
